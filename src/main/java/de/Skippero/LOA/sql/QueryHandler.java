...
public class QueryHandler {
    ...
    private void createTables() {
        ...
        try {
            ...
            executeUpdateSync("CREATE TABLE IF NOT EXISTS plannedRaidsMeta(id bigint PRIMARY KEY AUTO_INCREMENT, raidId bigint, name VARCHAR(128), description VARCHAR(2048), duration VARCHAR(64), startDate VARCHAR(64))");
    ...
    public void saveOrUpdateRaid(Raid raid) {
        try {
            ...
            executeUpdateSync("INSERT INTO plannedRaidsMeta (raidId, name, description, duration, startDate) VALUES ('"
                    + raid.getId() + "','"
